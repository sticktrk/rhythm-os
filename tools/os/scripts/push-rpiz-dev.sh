...
#
# Usage:
#   ./tools/os/scripts/push-rpiz-dev.sh <user@host> [--remote-path <path>]
#
# Examples:
#   ./tools/os/scripts/push-rpiz-dev.sh root@rhythm-rpiz.local
#   ./tools/os/scripts/push-rpiz-dev.sh root@192.168.7.2
