...
#
# Usage:
#   ./tools/os/scripts/build/build-rpiz-builder-image.sh              # build only
#   ./tools/os/scripts/build/build-rpiz-builder-image.sh --push       # build + push
#   ./tools/os/scripts/build/build-rpiz-builder-image.sh --image-tag dtconcepts/rhythm-rpiz-builder:v2
