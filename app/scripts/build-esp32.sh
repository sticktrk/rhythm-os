#!/bin/bash
# Build and flash ESP32-C6 firmware for Rhythm Lighting
#
...
# ESP32 source (may be in a submodule)
if [ -d "$PROJECT_ROOT/rhythm-lighting" ]; then
    ESP32_DIR="$PROJECT_ROOT/rhythm-lighting/rust/bins/rhythm-esp32"
else
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Build and flash ESP32-C6 firmware for Rhythm Lighting"
            echo ""
            echo "Options:"
