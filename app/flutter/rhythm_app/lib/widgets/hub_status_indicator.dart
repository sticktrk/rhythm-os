...
/// Beta badge with industrial styling.
class BetaBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: padding,
      decoration: BoxDecoration(
        color: IndustrialColors.statusAmber.withValues(alpha: 0.15),
        borderRadius: BorderRadius.circular(4),
        border: Border.all(
          color: IndustrialColors.statusAmber.withValues(alpha: 0.4),
          width: 1,
        ),
      ),
      child: Text(
        ...
        style: TextStyle(
          ...
          letterSpacing: 1,
          color: IndustrialColors.statusAmber,
        ),
      ),
    );
  }
