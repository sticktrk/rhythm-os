...
impl TestHarness {
    ...
    pub fn set_settings(&self, power_save: Option<bool>) -> String {
        commands::do_settings_set(&self.state, power_save, None, None, None, None, None)
    ...
    pub fn set_mode_configs(&self, configs: Vec<ModeConfig>) {
        commands::do_settings_set(&self.state, None, None, Some(configs), None, None, None)
            .expect("do_settings_set failed");
    }
...
fn create_rhythm_adaptive_runtime(
