//! Matrix coverage for OffPress brightness invariant.
//!
//! The user-facing contract is simple: pressing the bottom button always dims
//! to 1%, regardless of time of day, season, or what state the room was in.
//! This file iterates the matrix so any future bug ("but did you try at hour
//! X with state Y?") is caught without asking that question manually.
//!
...
//! regimes (winter/summer, early-morning/midday/evening), all four room
//! states the engine can be in entering the press, and idle/active mode.
